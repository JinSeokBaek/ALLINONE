...
public class WarningActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnUrl = (Button) findViewById(R.id.btnUrl);//"192.168.255.81"
        //이부분 수정하면됨
        url = s.getString("ip", "192.168.43.129");
    ...
    protected void onPause() {
        ...
        if (wvWarning != null) {
            try {
                Class.forName("android.webkit.WebView").getMethod("onPause", (Class[]) null).invoke(wvWarning, (Object[]) null);
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
